  ...
  const comments: CommentProps[] = [
    {
      ...
      author: {
        name: '9SS8XC',
        avatar:
          'https://pump.mypinata.cloud/ipfs/Qmbny4caFxuQ9dV9z37AxqQa2S7N2pavbPXHapF4agDXBg?img-width=16&amp;img-dpr=2&amp;img-onerror=redirect',
      ...
      likes: 0,
      image:
        'https://pump.mypinata.cloud/ipfs/QmYmKcCSyhZVR4FB7t7nWoy1pp5LcfWBwHLvRwDuAUTz7y'
    },
    {
      id: '4054839',
      author: {
        name: 'wolf',
        avatar:
          'https://pump.mypinata.cloud/ipfs/QmUeioJEkpgx327RX5VbiZecrN1vLfZ7hcVDXYTBgbRjwr?img-width=16&amp;img-dpr=2&amp;img-onerror=redirect',
        color: 'rgb(192, 209, 221)'
      },
      timestamp: '13:47:38',
      content:
        "Easy sendor... binance dog hit 1 mil, this is second best if not better since it's a cat. SEND IT!",
      likes: 1
    },
    {
      id: '4054137',
    ...
    },
    {
      ...
      author: {
        name: 'manorman',
        avatar:
          'https://pump.mypinata.cloud/ipfs/QmXQEdNu7HwbwagTXAnjTWZ8raQWxM4BujgQjsgdaYmsdY?img-width=16&amp;img-dpr=2&amp;img-onerror=redirect',
    ...
    },
    {
      ...
      author: {
        name: 'PG',
        avatar:
          'https://pump.mypinata.cloud/ipfs/QmZt5vFWewLvhDZMMM7cyZ9cFdMEU1zsurcUj4ihqy5cx5?img-width=16&amp;img-dpr=2&amp;img-onerror=redirect',
    ...
    },
    {
      ...
      author: {
        name: 'memesendor',
        avatar:
          'https://pump.mypinata.cloud/ipfs/QmfQ6KE59mcsswd3XGeereB2XRDBDBqJsaH5asBEt732aE?img-width=16&amp;img-dpr=2&amp;img-onerror=redirect',
      ...
      {:else}
        ...
        >
          ...
          <div class="grid grid-cols-4 rounded-lg bg-[#2e303a] sm:grid-cols-6">
            ...
            <div class="col-span-1 p-3 text-left font-normal sm:hidden">
              txn
            </div>
